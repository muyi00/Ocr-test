...
public class TesseractUtil {
     ...
     * @return
     */
    public Bitmap catchPhoneRect(final Bitmap bmp) {
        ...
        //如果高度合理，且捕捉到的字符数量为11个，那么基本可以确定，这是一个12位的文字块，否则跳过，解析下一帧
        if (bottom - top > (right - left) / 5 || bottom - top == 0 || charCount != 12) {
            return null;
        }
